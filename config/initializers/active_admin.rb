ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Music Mayhem"
  ...
  config.register_javascript 'active_admin_songs.js'
  config.register_javascript '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js'
  config.register_javascript '//cdnjs.cloudflare.com/ajax/libs/floatthead/1.4.2/jquery.floatThead-slim.min.js'
  config.register_javascript '//cdnjs.cloudflare.com/ajax/libs/floatthead/1.4.2/jquery.floatThead.min.js'
  config.register_stylesheet '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css'
  config.register_stylesheet '//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css'
end
